"""
Django settings for sales_module project.
...
SECRET_KEY = 'ro_q8fcd08z56a4i3-94eo^#l_-v--8c*f1r(0m%%0m+07z@og'
...
ROOT_URLCONF = 'sales_module.urls'
...
WSGI_APPLICATION = 'sales_module.wsgi.application'
